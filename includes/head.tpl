...
<link href="{$WEB_ROOT}/templates/{$template}/css/slidebars.min.css" rel="stylesheet">

<!-- jQuery -->
<script src="{$BASE_PATH_JS}/jquery.min.js"></script>
<script src="{$WEB_ROOT}/templates/{$template}/js/antimatter.js"></script>
<script src="{$WEB_ROOT}/templates/{$template}/js/slidebars.min.js"></script>
{if $kbarticle.title}<script src="https://google-code-prettify.googlecode.com/svn/loader/run_prettify.js"></script>{/if}
